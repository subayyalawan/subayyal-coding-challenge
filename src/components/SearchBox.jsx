...
const SearchBox = ({ searchQuery, setSearchQuery, handleGenderFilter }) => {
  ...
  return (
    <div className="bg-cyan-50">
      <div className="container mx-auto flex justify-center items-center flex-col py-8">
        <div className="xl:w-1/3 lg:w-1/2 sm:w-3/5 w-full px-4 flex justify-between">
          <input
            type="text"
        ...
        <div className="mt-4 flex justify-between items-center xl:w-1/4 lg:w-2/5 sm:w-3/5 w-full px-4">
          <FontAwesomeIcon
            icon={faSliders}
            className={`${
              genderFilter
          ...
          <button
            ...
            className={`${
              genderFilter === "female"
                ? "bg-cyan-500 text-white"
                : "hover:bg-cyan-100 bg-transparent text-cyan-500"
            } border-2 border-cyan-500/70 sm:w-1/4 w-[30%] py-2 px-4  font-roboto rounded-full cursor-pointer transition-all duration-150`}
            onClick={handleGenderChange}
          >
            Female
          </button>
          <button
            ...
            className={`${
              genderFilter === "male"
                ? "bg-cyan-500 text-white"
                : "hover:bg-cyan-100 bg-transparent text-cyan-500"
            } border-2 border-cyan-500/70 sm:w-1/5 w-1/4 py-2 px-4  font-roboto rounded-full cursor-pointer transition-all duration-150`}
            onClick={handleGenderChange}
          >
            Male
          </button>
